...
public class Main {
    ...
    static ListOfChairs list = new ListOfChairs();
    ...
    public static void main(String[] args) {
        ...
        public static void printDetails(Chair ourChair) {
            log.info("What we need? ");
            log.info("\n" + ourChair);
        }
        public static void printStatistic(){

            log.info("\nprice of all booking: " + list.findAveragePrice());
            log.info("Chair with max price: " + list.findAveragePrice());
            log.info("Average price: " + list.findAveragePrice());
            log.info("Cheap and ex.: " + list.groupByPrice());
        }
        ...
        public static List<Detail> addingDetails(Chair ourChair, double chairCoverWidth, double chairCoverLength,
            ...
            try {
                ...
                log.info("Details are ready for using");
            }
            return details;
        }
    }
